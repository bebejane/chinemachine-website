...
import { PHONE, EMAIL, INSTAGRAM_URL, INSTAGRAM_APP_URL, FACEBOOK_URL, FACEBOOK_APP_URL } from '../../constants';
					...
					<div id='store-info-right'>
						<div id='store-info-right-top'>
							...
							<Link id='store-info-appointment-button' to={{ pathname: '/appointment', langCode }}>
								<Button style={{ backgroundColor: '#fce100', color: '#000' }}>{dict.bookNow}</Button>
							</Link>
						</div>
					</div>
